	...
	public FlightSelection() {
		...
		btnBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String response = Client.create().resource( "http://localhost:8080/flight/reservation/"+flightNumber +"?row="+seatRow+"&number="+seatNumber+"&seatclass="+seatClass.replace(" ", "%20")).get( String.class ) ;
